...
/**
 * the forceast class
 * contains all data classes needed to create forecast objects from json return value from API call
 *
 * classes generated by using the json to kotlin generator plugin
 */
